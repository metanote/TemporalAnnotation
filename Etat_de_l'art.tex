...
\paragraph{}
Les bases de connaissances jouent un rôle de plus en plus important dans l'intelligence du Web et dans la recherche, ainsi qu'elles favorisent l'intégration de l'information. La plupart des bases de connaissances contiennent des informations relatives à des actions dans le temps qui ne possèdent pas la bonne structure capable de relier directement l'événement au temps ou la période associer à cette événement.
...
\subsubsection{RDF Temporel ou tRDF}
\paragraph{}
